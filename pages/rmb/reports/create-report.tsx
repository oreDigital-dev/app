    ...
    <div className="m-[20px] rounded-md">
      <div className=" bg-white h-auto relative p-[20px] rounded-md shadow-sm shadow-neutal-300">
        ...
        <div className="flex mt-4 justify-evenly">
          <div className="flex p-[13px] bg-white border-[1px] border-solid border-[#5160B3] w-2/5 rounded-full">
        ...
        <div>
          ...
          <div>
            ...
            <button type="submit" className="py-3 pl-2 pr-2 w-40 flex text-white items-center justify-center  rounded-lg bg-[#5160B3]">
              <span>Send</span>
            </button>
          </div>
          </div>
