    ...
    },
    {
      ...
      cell: (row) =>
        row.employeeStatus === "APPROVED" ? (
          ...
          <button onClick={() => handleApproveOrReject(row.id, "approve")}>
            <BsToggleOff className="text-green-500 text-2xl" />
          </button>
        ),
    },
    {
      ...
      cell: (row) =>
        row.employeeStatus === "REJECTED" ? (
          <button>
            <BsToggleOn className="text-red-500 text-2xl" />
          </button>
        ) : (
          <button onClick={() => handleApproveOrReject(row.id, "reject")}>
            <BsToggleOff className="text-red-500 text-2xl" />
          </button>
        ),
    },
    {
      ...
      <div className=" bg-white p-[20px] rounded-md shadow-sm shadow-neutal-300">
        ...
        <div className="flex mt-6 justify-between">
          <div className="flex gap-6">
            ...
            <input
              type="file"
              className="text-black py-2 pl-4 pr-4 shadow-sm shadow-black rounded-xl text-sm"
            />
