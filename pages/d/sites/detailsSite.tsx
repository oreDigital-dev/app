    ...
    <div className=" bg-white p-[20px] rounded-md shadow-sm shadow-neutal-300">
      <div className="flex items-start justify-between">
        ...
        <div className='flex items-start justify-between mt-6 border-b-2 border-b-gray-200 pb-4'>
            <p>Location</p>
            <button className='text-app'><Link href="/d/sites/mapSite"><span>Show on Map</span></Link></button>
        </div>
        <div className='mt-6'>
        ...
        {minerals.map((mineral) => (
            <button key={mineral} className="py-2 flex items-center gap-2 px-4 rounded-full bg-gray-200 ml-4">
              <span>{mineral}</span>
            </button>
          ))}
        ...
        <div className='flex items-start justify-between mt-6 border-b-2 border-b-gray-200 pb-4'>
            <p>Site logs</p>
            <button className='text-app'><Link href="/d/sites"><span>Go to site logs</span></Link></button>
        </div>
