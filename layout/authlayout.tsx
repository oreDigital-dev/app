...
const AuthLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center authBack xl:w-[100vw] bg-cover bg-transparent">
      <div className="z-40 py-4 bg-white  mx-auto flex flex-col  border rounded-lg w-[40%]  px-4 space-y-4 h-auto">
