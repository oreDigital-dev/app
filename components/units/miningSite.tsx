...
export default function MiningSite(props: MiningSiteProps) {
  return (
    <div className={`flex items-center p-3 min-w-[300px]  gap-4 border cursor-pointer rounded-lg shadow-sm  ${props.isSelected ? 'bg-app/20 border-2 border-app' : 'border-black-100'}`} onClick={() => props.setSelectedSite(props.id)}>
