...
export default function RegisteredSite(props: RegisteredSiteProps) {
  ...
  return (
    <div className="flex items-center p-3 hover:bg-grey-200 hover:shadow-xl min-w-[300px]  gap-4 border cursor-pointer rounded-lg shadow-sm">
      {/* <Image src={"/backGround.jpg"} alt={props.location} width={100} height={100} className="w-auto" /> */}
      <div>
        <div className="h-20 w-20 bg-gray-200 rounded-md relative">
          <Image src="/backGround.jpg" alt={`${props.location}`} fill />
        </div>
